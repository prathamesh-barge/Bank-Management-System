...
public class Signup2 extends JFrame implements ActionListener {
    ...
    Signup2(String formno) {
        ...
        this.add(l4);
        String[] Category = new String[]{"General", "OBC", "SC", "ST", "EWS","Other"};
        ...
        buttonGroup1.add(this.e1);
        buttonGroup1.add(this.e2);
        ...
        l13.setFont(new Font("Raleway", 1, 12));
        ...
        this.next.setBounds(570, 600, 100, 30);
    ...
    public void actionPerformed(ActionEvent e) {
        String rel = (String)this.comboBox.getSelectedItem();//fetching value and storing in a string
        ...
        try {
            if (!this.textPan.getText().equals("") && !this.textAadhar.getText().equals("")) {
                Connn c = new Connn();
                String q = "insert into Signup2 values('" + this.formno + "', '" + rel + "', '" + cate + "','" + inc + "','" + edu + "','" + occ + "','" + pan + "','" + addhar + "','" + scitizen + "','" + eAccount + "')";
                int i = c.statement.executeUpdate(q);
